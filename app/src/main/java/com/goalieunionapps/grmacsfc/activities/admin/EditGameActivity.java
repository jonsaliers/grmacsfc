...
import com.goalieunionapps.grmacsfc.models.GameUpdateKeys;
...
public class EditGameActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            originalGame = getIntent().getParcelableExtra(GRMacsFCIntents.EXTRA_GAME);
            refreshData = false;
        } else {
            originalGame = null;
            keys = null;
    ...
    protected void onResume() {
        ...
        if (!refreshData) {
            ...
            //get the game ID
            Game game = getIntent().getParcelableExtra(GRMacsFCIntents.EXTRA_GAME);
    ...
    public void onEditStatsClick() {
        startActivity(GRMacsFCIntents.createEditGameStatsIntent(this, originalGame.gameID));
    }
